    ...
    <div class="flex flex-col md:flex-row items-center gap-6 md:w-[90%]">
        <div class="flex flex-col gap-5 p-5 w-full md:w-1/2">
            ...
            <h3 class=" md:w-[80%] text-3xl md:text-4xl font-semibold text-left">
                Transform your<span class="text-[#E91E63] animate-pulse"> website </span>into a customer magnet</h3>
            <p class="text-justify leading-8 text-slate-700">
                Your website is your digital storefront to captivate, engage, and convert visitors into customers. Make
                    ...
                    <a href="{{ route('wordpress-website-design') }}"
                        ...
                        <div class="flex flex-col w-3/4 text-center">
                            ...
                            <p class="text-xs md:text-sm text-gray-300">
                                ...
                                templates that reflects your brand's essence.
                            </p>
                        </div>
                    </a>
                </div>
                    ...
                    <a href="{{ route('e-commerce') }}"
                        ...
                        <div class="flex flex-col w-3/4 text-center">
                            ...
                            <p class="text-xs md:text-sm text-gray-300"> eCommerce web design solutions take your online
                                store to the next level and support you in making more revenue with online marketing.
                            </p>
                        </div>
                    </a>
                </div>
                    ...
                    <div class="flex justify-between items-center p-3">
                        <div class="flex flex-col gap-3">
                            {{-- <p class="text-xs md:text-sm lg:text-base uppercase text-gray-600">back link creation
                                service</p> --}}
                            <h2 class="text-lg md:text-xl lg:text-2xl font-bold text-[#E91E63] animate-pulse">Web
                                Hosting
                            </h2>
                        </div>
