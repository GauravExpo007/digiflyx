<div class="p-5 md:p-10 md:py-20">
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">

        {{-- Blog-1 (September 17, 2024) --}}
        <div
            class="hover:scale-105 duration-500 min-w-[300px] snap-center bg-gradient-to-r from-[#2EFDE1] to-[#75AAF8] p-4 rounded-xl shadow-lg animate-slide-in-left">
            <img src="{{ asset('assets/blogs/5-recent-google-updates-for-2024-300x169.webp') }}" alt="Google Updates 2024"
        ...
        {{-- Blog-2 (September 11, 2024) --}}
        <div
            class="hover:scale-105 duration-500 min-w-[300px] snap-center bg-gradient-to-r from-[#2EFDE1] to-[#75AAF8] p-4 rounded-xl shadow-lg animate-slide-in-left">
            <img src="{{ asset('assets/blogs/seo-success.webp') }}" alt="SEO Tools 2024" class="w-full h-40 rounded-lg">
        ...
        {{-- Blog-3 (September 9, 2024) --}}
        <div
            class="hover:scale-105 duration-500 min-w-[300px] snap-center bg-gradient-to-r from-[#2EFDE1] to-[#75AAF8] p-4 rounded-xl shadow-lg animate-slide-in-right">
        ...
        {{-- Blog-5 (September 3, 2024) --}}
        <div
            class="hover:scale-105 duration-500 min-w-[300px] snap-center bg-gradient-to-r from-[#2EFDE1] to-[#75AAF8] p-4 rounded-xl shadow-lg animate-slide-in-right">
            <img src="{{ asset('assets/blogs/Top-10-SEO-Tools.webp') }}" alt="SEO Tools 2024" class="w-full rounded-lg">
            <h3 class="text-[15px] font-semibold mt-4 mx-auto">Top 10 SEO Tools You Need in 2024 – Ultimate List</h3>
