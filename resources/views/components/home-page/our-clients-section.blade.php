<div
    class="w-full min-h-[600px] lg:h-auto flex flex-col justify-center items-center gap-5 md:gap-10 lg:gap-16 bg-left-top md:bg-right py-5 md:py-10 bg-gradient-to-b from-[#c9ede7] to-[#edbebe]">

    <div class="container mx-auto px-6 text-center">
        <h3
            class="bg-gradient-to-r from-[#340446] to-[#f31054] bg-clip-text text-transparent text-lg md:text-xl uppercase">
            Our happy customers</h3>
        <h2 class="text-2xl md:text-3xl xl:text-4xl font-bold text-gray-900 mt-2">Some of our <span
                class="text-[#E91E63] animate-pulse">Clients</span> </h2>
    </div>

    <div class="max-w-7xl px-4 sm:px-6 lg:px-8 flex flex-col gap-5 md:gap-10 w-full object-center bg-no-repeat">


        <div
            class="max-w-screen-xl mx-auto overflow-hidden grid grid-cols-2 md:grid-cols-3 xl:grid-cols-5 gap-4 text-lg">
